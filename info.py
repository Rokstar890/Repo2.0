...
STREAM_SITE = (environ.get('STREAM_SITE', 'Linksmoney.in'))
STREAM_API = (environ.get('STREAM_API', '9c1e1fed194419e8e912c4084cf99de0eccfb408'))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADRESS', '0.0.0.0'))
